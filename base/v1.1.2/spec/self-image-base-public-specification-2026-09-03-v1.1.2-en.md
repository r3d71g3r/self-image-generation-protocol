...
The execution procedure and generation behavior described in this specification have been tested primarily in the following environment.
...
This records the conditions actually tested at the time of publication; it neither guarantees compatibility nor limits the protocol to this model. Interpretation, execution availability, generation tendencies, and reproducibility may differ with another model, mode, interface, image-generation path, or later product update.
