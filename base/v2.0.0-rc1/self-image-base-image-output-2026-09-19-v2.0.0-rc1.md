...
Keep all evidence handling, target resolution, self-image acquisition, supplementation, compiler state, alternatives, validation, repair, drafts, and the locked production prompt internal. Do not expose the production prompt in a fenced block or in any other form.
